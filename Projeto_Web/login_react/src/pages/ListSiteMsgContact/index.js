                ...
                <div className="wrapper">
                    <div className="row">
                        <div className="top-content-adm">
                            <span className="title-content">Listar Pacientes</span>
                        ...
                        <table className="table-list">
                            <thead className="list-head">
                                <tr>
                                    ...
                                    <th className="list-head-content table-sm-none">Idade</th>
                                    <th className="list-head-content table-md-none">Cidade</th>
                                    <th className="list-head-content table-md-none">Estado</th>
                            ...
                            <tbody className="list-body">
                                {data.map(msgContact => (
                                    <tr key={msgContact.id}>
                                        ...
                                        <td className="list-body-content table-sm-none">{msgContact.idade}</td>
                                        <td className="list-body-content table-md-none">{msgContact.cidade}</td>
                                        <td className="list-body-content table-md-none">{msgContact.estado}</td>

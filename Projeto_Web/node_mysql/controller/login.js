    ...
    await User.update(dados, { where: { id: user.id } })
        .then(() => {
            ...
            transport.sendMail(message, function (err) {
                ...
                return res.json({
                    erro: false,
                    mensagem: "Enviado e-mail com instruções para recuperar a senha. Acesse a sua caixa de e-mail para recuperar a senha! (O email não irá chegar pois foi utilizado um email fake, basta substituir por um real em node_mysql/env)"
                });
            });
